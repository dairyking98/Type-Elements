...
newlines for multiple stacked lines, spaced 25.4/lpi mm apart (same
fixed-pitch convention, vertically - default 6 lines per inch).
Independent of the real cylindrical element pipeline (no draft, no
platen scallop, no placement-on-cylinder) - just flat extruded
outlines, for speed.
