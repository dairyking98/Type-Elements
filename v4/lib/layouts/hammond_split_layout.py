...
from .hammond_layout import (
    ...
    CATALOG_UNIVERSAL_MATHEMATICAL_BRACES,
    CATALOG_UNIVERSAL_HUNGARIAN,
    CATALOG_UNIVERSAL_MATHEMATICAL_GREEK,
...
LAYOUT_PRESETS_HAMMOND_SPLIT = {
    ...
    "Universal, Italian": list(CATALOG_UNIVERSAL_ITALIAN),
    "Universal, Portuguese": list(CATALOG_UNIVERSAL_PORTUGUESE),
    "Universal, Roumanian": list(CATALOG_UNIVERSAL_ROUMANIAN),
    "Ideal, Roumanian": list(CATALOG_IDEAL_ROUMANIAN),
    ...
    "Ideal, Polish": list(CATALOG_IDEAL_POLISH),
    "Ideal, Hungarian": list(CATALOG_IDEAL_HUNGARIAN),
    "Universal, Chilian": list(CATALOG_UNIVERSAL_CHILIAN),
    "Universal, Russian": list(CATALOG_UNIVERSAL_RUSSIAN),
    "Universal, Bohemian": list(CATALOG_UNIVERSAL_BOHEMIAN),
    "Ideal, Italian": list(CATALOG_IDEAL_ITALIAN),
    "Universal, Dutch (Fractions)": list(CATALOG_UNIVERSAL_DUTCH_FRACTIONS),
    ...
    "Universal, Bulgarian": list(CATALOG_UNIVERSAL_BULGARIAN),
    "Ideal, Chilian": list(CATALOG_IDEAL_CHILIAN),
    "Universal, Polish": list(CATALOG_UNIVERSAL_POLISH),
    "Universal, Math (braces)": list(CATALOG_UNIVERSAL_MATHEMATICAL_BRACES),
    "Universal, Math (Greek)": list(CATALOG_UNIVERSAL_MATHEMATICAL_GREEK),
    "Universal, Hungarian": list(CATALOG_UNIVERSAL_HUNGARIAN),
}
